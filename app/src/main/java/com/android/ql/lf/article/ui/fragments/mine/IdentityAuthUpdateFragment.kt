...
import com.android.ql.lf.baselibaray.utils.getScreen
...
class IdentityAuthUpdateFragment : IdentityAuthFragment() {
    ...
    override fun initView(view: View?) {
        ...
        mTvIdentityAuthFailReason.visibility = View.GONE
        ...
        when (AuthStatus.getNameByFlag(UserInfo.user_status)) {
            ...
            AuthStatus.FAIL_AUTH -> {
                ...
                mTvIdentityAuthFailReason.visibility = View.VISIBLE
                mLlIdentityAuthBottomContainer.visibility = View.VISIBLE
            }
            else -> {
                mTvIdentityAuthZM.text = "审核中，请耐心等待……"
                mTvIdentityAuthFM.text = "审核中，请耐心等待……"
